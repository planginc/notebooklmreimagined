...
export function DashboardTabs({ activeTab, onTabChange }: DashboardTabsProps) {
  ...
  return (
    <div className="relative flex items-center gap-1 p-1 bg-[var(--bg-tertiary)] rounded-xl">
      {/* Animated indicator */}
      <motion.div
        className="absolute h-[calc(100%-8px)] bg-[var(--bg-surface)] rounded-lg shadow-md"
        initial={false}
        animate={{
